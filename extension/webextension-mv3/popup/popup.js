...
const defaultServerUrl = 'http://localhost:8081/v2';   // keep in sync with defaultServerUrl in options.js
...
function renderMatchesToHtml(resultJson, response, tabs, callback) {
    ...
    Tools.getUserSettingsForRender(items => {
        ...
        document.getElementById('ltIcon').src = chrome.runtime.getURL("images/logo34x34.png");
